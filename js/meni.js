...
function UrediNovost(nID, nNaslov, nAutor, nSlika, nOpis, nDetaljnije)
{
    var ajax;
    if (window.XMLHttpRequest)
    {
...
//           document.getElementById("promijeni").innerHTML = ajax.responseText;
    ...
    var url= "uredinovosti.php?nID="+nID+"&nNaslov="+nNaslov+"&nAutor="+nAutor+"&nSlika="+nSlika+"&nOpis="+nOpis+"&nDetaljnije="+nDetaljnije;
    ajax.open("POST", url, true);
    ajax.send();
    console.log(ajax.responseText);
}
